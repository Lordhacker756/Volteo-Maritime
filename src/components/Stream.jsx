...
const Stream = () => {
  return (
    <div className='bg-[#EAF5FF] w-[429px] mt-[10px] rounded-[10px] m-3 pt-5 overflowy-scroll' style={{boxShadow:"0px 0px 1px rgba(0,0,0,0.48)", maxHeight:"746px",overflowY:"scroll"}}>
    <div className="team_status flex justify-between items-center px-5 ">
        ...
        <img src={refreshing} className="w-[12.74px] h-[13px]" alt="" />
    </div>
